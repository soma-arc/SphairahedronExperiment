...
export default class SpheiraPrism {
    /**
     *
     * @param {number} zb
     */
    ...
    update() {
        ...
        this.inversionSphere = new Sphere(0.3,
                                          this.s4.center.y + 2.5,
                                          0,
                                          this.s2.r);
    ...
    computeSpheres() {
        // PI / 3
        // const r2 = (3 + this.zb * this.zb) / 3 - 1;
        // const r4 = 1;
        // this.s2 = new Sphere(1 - r2, 0, 0, r2);
        // this.s4 = new Sphere(0, this.zb, 0, r4);

        // (3, 3, 3) 332 662
        // const r2 = (3 + 2 * this.zb * this.zb) / 6;
        // const r4 = Math.sqrt(3) / 2;
        // this.s2 = new Sphere(1 - r2, 0, 0, r2);
        // this.s4 = new Sphere(-0.5, this.zb, 0, r4);

        //
        const r2 = (this.zb * this.zb - 3) / 3;
        const r4 = Math.sqrt(3);
        this.s2 = new Sphere(1 - r2, 0, 0, r2);
        this.s4 = new Sphere(-0.5 + Math.sqrt(3) / 2, this.zb, 0, r4);
//        console.log(this.s2);
//        console.log(this.s4);
    }
    ...
    computeSeedSpheres() {
        ...
        this.addSphereIfNotExists(this.seedSpheres,
                                  this.computeMinSeedSphere(this.vertexes[2], this.vertexes,
                                                            this.s2inv, this.s3inv, this.s4inv));
        this.addSphereIfNotExists(this.seedSpheres,
        ...
        this.addSphereIfNotExists(this.seedSpheres,
                                  this.computeMinSeedSphere(this.vertexes[4], this.vertexes,
                                                            this.s3inv, this.s4inv, this.s5inv));
        this.addSphereIfNotExists(this.seedSpheres,
    ...
    computeVertexes() {
        ...
        this.vertexes.push(this.computeIdealVertex(this.s2inv, this.s3inv, this.s4inv));
        this.vertexes.push(this.computeIdealVertex(this.s1inv, this.s4inv, this.s5inv));
        this.vertexes.push(this.computeIdealVertex(this.s3inv, this.s4inv, this.s5inv));
    ...
    select(mouse, scale) {
        ...
        if (Vec2.distance(mouse, new Vec2(this.zb, this.zc)) < 0.1) {
            this.selectedComponentId = SpheiraPrism.POINT_ZB_ZC;
    ...
    move(mouse) {
        if (this.selectedComponentId === SpheiraPrism.POINT_ZB_ZC) {
