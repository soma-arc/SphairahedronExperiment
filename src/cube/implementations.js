...
class CubeE extends SpheirahedraCube {
    ...
    computeSpheres() {
        ...
        this.s2 = new Sphere(1 - SQRT_3 * 0.5 * r2, 0, r2 * 0.5, r2);
        this.s4 = new Sphere((1 + r4) * 0.5, this.zb, (1 - r4) * SQRT_3 * 0.5, r4);
        this.s6 = new Sphere(-(1 - r6) * 0.5, this.zc, -(1 - r6) * SQRT_3 * 0.5, r6);
...
class CubeH extends SpheirahedraCube {
    ...
    computeSpheres() {
        ...
        this.s2 = new Sphere(1 - r2, 0, 0, r2);
        this.s4 = new Sphere(r4 / SQRT_2, this.zb, 1 - r4 / SQRT_2, r4);
        this.s6 = new Sphere(0, this.zc, -1 + r6, r6);
...
class CubeI extends SpheirahedraCube {
    ...
    computeSpheres() {
        ...
        this.s2 = new Sphere(1 - r2, 0, 0, r2);
        this.s4 = new Sphere(r4 / SQRT_2, this.zb, 1 - r4 / SQRT_2, r4);
        this.s6 = new Sphere(r6 / SQRT_2, this.zc, r6 / SQRT_2 - 1, r6);

        this.inversionSphere = new Sphere(this.s2.center.x,
                                          this.s6.center.y + 1.5,
                                          this.s2.center.z,
                                          0.3);
    }
}
